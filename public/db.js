...
//        res=JSON.parse(doc);
      ...
      document.getElementById('hdr_name').innerHTML=`<strong><em>${fname} ${mname}, ${lname}</em></strong>`;
      ...
      document.getElementById('obit_body1').innerHTML = `${fname} ${mname}, ${lname} from ${from} was born on ${dob} in ${pob}. ${fname} passed away on ${dod} in ${pod}.`
      document.getElementById('obit_body2').innerHTML = `${fname} was born to ${mother} and ${father} in ${pob}`
      document.getElementById('obit_body3').innerHTML = `${fname} is survived by ${survived}, and was preceded in death by ${preceded}`
      txt="";
